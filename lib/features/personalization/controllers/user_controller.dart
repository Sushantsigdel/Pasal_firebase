...
class UserController extends GetxController {
  ...
  // Save user record from any registration method
  Future<void> saveUserRecord(UserCredential? userCredentials) async {
    try {
      ...
      PLoaders.warningSnackBar(
          ...
          message:
              'Something went wrong while saving your information. You can try re-entering your information from the profile screen.');
    }
  }
}
